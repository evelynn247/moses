...
public class Swagger2 {
	...
	public Docket createRestApi() {
		...
		parameters.add(parameterBuilder.name("pf").description("渠道").required(false).build());
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("moses文档").description("post请求").termsOfServiceUrl("http://www.baidu.com")
				.version("1.0").build();
	}
}
