...
public class CacheRedisUtil {
	...
	@Resource(name = "cacheRedisClusterService")
	...
	public boolean hexists(String key,String field) {
		boolean sRet = false;
		try {
			sRet = redisClusterService.hexists(key,field);
		} catch (Exception e) {
			logger.error("redis getString error, key is {},error message is {}", key, e);
		}
		return sRet;
	...
	public String getSetString(String key, String value, int seconds) {
	    String result="";
		try {
			result = redisClusterService.getSet(key, value);
			redisClusterService.expire(key, seconds);
		} catch (Exception e) {
			logger.error("redis getSetString error, key is {},value is {},error message is {}", key, value, e);
		}
		return result;
	}
	...
	public Long rpush(String key, String... item) {
		try {
			return redisClusterService.rpush(key, item);
		} catch (Exception e) {
			logger.error("redis rpush error, key is {}, value is {}.", key, item, e);
		}
		return null;
	}
	/**
	...
	public String rpop(String key) {
		try {
			return redisClusterService.rpop(key);
		} catch (Exception e) {
			logger.error("redis rpop error, key is {}.", key,e);
		}
		return null;
	}
	public Long llen(String key) {
		try {
			return redisClusterService.llen(key);
		} catch (Exception e) {
			logger.error("redis llen error, key is {}.", key,e);
		}
		return 0L;
	}
	/**
