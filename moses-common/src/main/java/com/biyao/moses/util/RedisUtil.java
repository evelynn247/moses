...
public class RedisUtil {
	...
	public String getString(String key) {
		...
		try {
			...
			logger.error("[严重异常][redis]redis getString error, key is {},", key, e);
		}
		return sRet;
	}
	...
	public boolean setString(String key, String value, int seconds) {
		...
		try {
			...
			logger.error("[严重异常][redis]redis setString error, key is {},value is {},", key, value, e);
		}
		return bRet;
	}
	...
	public String getSetString(String key, String value) {
	    String result="";
		try {
			result = redisClusterService.getSet(key, value);
		} catch (Exception e) {
			logger.error("[严重异常][redis]redis getSetString error, key is {},value is {},", key, value, e);
		}
		return result;
	}
	...
	public Long incr(String key) {
		...
		try {
			...
			logger.error("[严重异常][redis]redis incr error, key is {},", key, e);
		}
		return incr;
	}
	...
	public String hgetStr(String key, String field) {
		...
		try {
			...
			logger.error("[严重异常][redis]redis hgetAll error, key is {},", key, e);
		}
		return result;
	}
	...
	public boolean hmset(String key, Map<String, String> hash) {
		...
		try {
			...
			logger.error("[严重异常][redis]redis hmsetString error, key is {},value is {}", key, JSON.toJSONString(hash), e);
		}
		return bRet;
	}
	...
	public boolean hset(String key, String field, String value) {
		...
		try {
			...
			logger.error("[严重异常][redis]redis hmsetString error, key is {},value is {},", key, field, e);
		}
		return bRet;
	}
	...
	public boolean del(String key) {
		try {
			...
			logger.error("[严重异常][redis]redis del error, key is {},", key, e);
			return false;
		}
	}
	...
	public List<String> hmget(String key, String[] fields) {
		...
		try {
			...
			logger.error("[严重异常][redis]redis hmget error, key is {}, fields {},", key, JSON.toJSONString(fields), e);
		}
		return hmget;
	}
	...
	public String hget(String key, String field) {
		...
		try {
			...
			logger.error("[严重异常][redis]redis hmget error, key is {}, field {},", key, field, e);
		}
		return result;
	}
	...
	public Long lpush(String key, String... item) {
		try {
			...
			logger.error("[严重异常][redis]redis lpush error, key is {}, value is {}.", key, item, e);
		}
		return null;
	}
	...
	public List<String> lrange(String key, int start, int end) {
		try {
			...
			logger.error("[严重异常][redis]redis lrange error, key is {}, start is {}, end is {}.", key, start, end, e);
		}
		return null;
	}
	...
	public Long expire(String key, int seconds) {
		try {
			...
			logger.error("[严重异常][redis]redis expire error, key is {}, seconds is {}.", key, seconds, e);
		}
		return null;
	}
	...
	public String ltrim(String key, int start, int end) {
		try {
			...
			logger.error("[严重异常][redis]redis ltrim error, key is {}, start is {}, end is {}.", key, start, end, e);
		}
		return null;
	}
	...
	public Set<String> smems(String key) {
		try {
			...
			logger.error("[严重异常][redis]redis smems error, key is {}，", key, e);
		}
		return null;
	}
    ...
    public boolean lock(String key,int lockTime, long timeout) {
    	...
    	try {
    		...
    		logger.error("[严重异常][redis]获取锁失败",e);
    	}
    	return locked;
    }
	...
	public void unlock(String key) {
		try {
			...
			logger.error("[严重异常][redis]redis unlock error, key is {}", key, e);
		}
	}
	...
	public Long zadd(String key, double score, String member) {
		try {
			...
			logger.error("[严重异常][redis]redis zadd error, key is {}", key, e);
		}
		return null;
	}
	...
	public Set<String> zrange(String key, long start, long end) {
		try {
			...
			logger.error("[严重异常][redis]redis zrange error, key is {}", key, e);
		}
		return null;
	}
	...
	public Long zcard(String key) {
		try {
			...
			logger.error("[严重异常][redis]redis zcard error, key is {}", key, e);
		}
		return 0L;
	}
	...
	public Set<String> zrevrange(final String key, final long start, final long end) {
		try {
			...
			logger.error("[严重异常][redis]redis zrevrange error, key is {}", key, e);
		}
		return null;
	}
	...
	public Double zscore(final String key, final String member) {
		try {
			...
			logger.error("[严重异常][redis]redis zscore error, key is {}", key, e);
		}
		return null;
	}
	...
	public Long zcount(String key, double min, double max) {
		try {
			...
			logger.error("[严重异常][redis]redis zcount error, key is {}", key, e);
		}
		return null;
	}
	...
	public Long zremrangeByRank(String key, long start, long end) {
		try {
			...
			logger.error("[严重异常][redis]redis zremrangeByRank error, key is {}", key, e);
		}
		return null;
	}
	...
	public boolean sismember( String key, final String member) {
		try {
			...
			logger.error("[严重异常][redis]redis sismember error, key is {}", key, e);
		}
		return false;
	}
	...
	public Long sadd(String key, String member) {
		try {
			...
			logger.error("[严重异常][redis]redis sadd error, key is {}", key, e);
		}
		return 0l;
	}
	...
	public Long batchSadd(String key, String... member) {
		try {
			...
			logger.error("[严重异常][redis]redis batchsadd error, key is {}", key, e);
		}
		return 0l;
	}
	...
	public String lindex(String key, long index) {
		try {
			...
			logger.error("[严重异常][redis]redis lindex error, key is {}", key, e);
		}
		return null;
	}
	...
	public Boolean exist(String key, Boolean[] isException){
		...
		try{
			...
			logger.error("[严重异常][redis]redis exist error, key is {}", key, e);
			isException[0] = true;
		}
		return false;
	}
