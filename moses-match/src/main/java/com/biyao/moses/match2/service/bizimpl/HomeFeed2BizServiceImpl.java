 ...
 * @date 2019/10/9
 * V2.1.0版本 使用ibcf*0.4 + tag*0.5 + hots*0.1召回
 **/
@Slf4j
@Component(value = BizNameConst.HOME_FEED2)
public class HomeFeed2BizServiceImpl implements BizService{
    //各召回源的权重
    private static final Double IBCF_WEIGHT = 0.4;
    private static final Double HOT_SALE_WEIGHT = 0.1;
    private static final Double TAG_WEIGHT = 0.5;
    //返回的最大商品数量
    ...
    @BProfiler(key = "HomeFeed2BizServiceImpl.match",
