...
public class TestHomeSliderMatch {

    @Resource
    HomeSliderMatch homeSliderMatch;
    ...
    public void test1(){
        ...
        Map<String, List<TotalTemplateInfo>> result = homeSliderMatch.executeRecommendMatch(dataKey, matchDataSourceTypeConf, uuid);
